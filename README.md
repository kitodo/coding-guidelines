...
> [!NOTE]
> Dieses Dokument ist gemäß § 11 der [Vereinssatzung](https://www.kitodo.org/fileadmin/groups/kitodo/Verein/2025-06-20_Satzung_Kitodo_eV.pdf) auf Beschluss der Mitgliederversammlung des Vereins [Kitodo. Key to digital objects e. V.](https://www.kitodo.org/verein/ueber-den-verein) in Kraft getreten und ersetzt alle als PDF-Dokumente publizierten älteren Fassungen. Änderungen an diesem Dokument können in Form von [Pull Requests](https://github.com/kitodo/coding-guidelines/pulls) vorgeschlagen sowie diskutiert werden und erfordern die Zustimmung der Mitgliederversammlung.
